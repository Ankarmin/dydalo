...
import type { SiteConfig } from "@/lib/data-store.types";
...
const defaultConfig: SiteConfig = {
  ...
  sizeGuide: "",
  faq: [],
  heroSettings: { title: "THE REAL CREAM", subtitle: "UNDERGROUND STREETWEAR", ctaText: "VER CATÁLOGO", ctaLink: "/catalogo", backgroundImage: "/images/dydalo-hero.jpg" },
