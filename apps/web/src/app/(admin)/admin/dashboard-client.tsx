...
import type { AdminProduct, Order } from "@/lib/stores";
...
export function DashboardClient() {
  const products = useStoreData(() => productsStore.getAll(), [] as AdminProduct[]);
  const orders = useStoreData(() => ordersStore.getAll(), [] as Order[]);
