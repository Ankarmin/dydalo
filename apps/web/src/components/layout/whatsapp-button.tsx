...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center overflow-hidden rounded-full bg-gradient-to-br from-[#25D366] to-[#128C7E] text-white shadow-lg shadow-black/20 transition-all duration-300 hover:w-56 motion-safe:animate-bounce"
    >
