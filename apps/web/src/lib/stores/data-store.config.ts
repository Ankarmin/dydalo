...
const DEFAULT_CONFIG: SiteConfig = {
  ...
  faq: [
    ...
    { id: "15", category: "Pagos", question: "¿Qué métodos de pago aceptan?", answer: "Pagas online con tarjeta, Yape u otros medios a través de MercadoPago, de forma segura. Para pedidos coordinados por WhatsApp te indicamos cómo completar el pago." },
