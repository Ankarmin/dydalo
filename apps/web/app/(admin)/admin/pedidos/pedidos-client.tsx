...
import type { Order, OrderStatus } from "@/lib/data-store";
import { ORDER_STATUSES } from "@/lib/data-store";
...
export function PedidosClient() {
  ...
  useEffect(() => {
    seedIfEmpty();
    setOrders(ordersStore.getAll().toSorted((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()));
    setLoading(false);
  }, []);
