...
export function SocialWidget() {
  return (
    <nav
      ...
      className="fixed right-0 top-1/2 -translate-y-1/2 z-30 hidden sm:flex flex-col gap-2.5 p-2.5 rounded-l-2xl backdrop-blur-xl bg-background/60 border border-accent/30 shadow-lg shadow-black/10"
    >
